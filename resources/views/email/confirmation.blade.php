                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td esd-links-color="#cccccc" class="esd-block-text es-p5b es-infoblock" esd-links-underline="none" align="center">
                                                                <p>Put your preheader text here. <a target="_blank" href style="text-decoration: none;">View in browser</a></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table style="background-position: left top;" width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                <h1 style="color: #333333; font-size: 20px;"><strong>CONFIRM YOUR </strong></h1>
                                                                <h1 style="color: #333333; font-size: 20px;"><strong>&nbsp;EMAIL?</strong></h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p35r es-p40l" align="left">
                                                                <p style="text-align: center;">There was a request to verify your email</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p25t es-p40r es-p40l" align="center">
                                                                <p>If did not make this request, just ignore this email. Otherwise, please click the button below to confirm email and complete registration:</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center">
                                                                <span class="es-button-border"> <a href="{{$verification_link}}" class="es-button" target="_blank">CONFIRM EMAIL</a> </span> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
