                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td esd-links-color="#cccccc" class="esd-block-text es-p5b es-infoblock" esd-links-underline="none" align="center">
                                                                <p>E Business <a target="_blank" href style="text-decoration: none;">View in browser</a></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                    ...
                    <tr>
                        <td class="esd-stripe" style="background-color: rgb(250, 250, 250);" bgcolor="#fafafa" align="center">
                            <table class="es-content-body" style="background-color: rgb(255, 255, 255);" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                <tbody>
                                <tr>
                                    <td class="esd-structure es-p10t es-p15b es-p20r es-p20l" style="border-radius: 10px 10px 0 0px; background-color: rgb(11, 83, 148); background-position: left top;" bgcolor="#0b5394" align="left">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tbody>
                                            <tr>
                                                <td class="esd-container-frame" width="560" valign="top" align="center">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="560" valign="top" align="center">
                                                    <table style="background-position: left top;" width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-image es-p5t es-p5b" align="center">
                                                                <a target="_blank"> <img src="https://ffc.com/wp-content/uploads/2018/03/Welcome-New-Staff-FFC-Chicago-1030x687.jpg" alt style="display: block;" width="175"> </a> </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                <h1 style="color: #333333; font-size: 20px;"><strong>Welcome </strong></h1>
                                                                <h1 style="color: #333333; font-size: 20px;"><strong>&nbsp;E-Business?</strong></h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p40r es-p40l" align="left">
                                                                <p style="text-align: center;">HI, <span style="font-weight: bold">{{$name}}</span></p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p35r es-p40l" align="left">
                                                                <p style="text-align: center;">Thank You for Joining our platform</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p25t es-p40r es-p40l" align="center">
                                                                <p>If did not make this request, just ignore this email. Otherwise, there will be an email to help you confirm your email and continue setting up ur profile:</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center">
                                                                <span class="es-button-border"> <a href="https://viewstripo.email/" class="es-button" target="_blank">Activate</a> </span> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="361" align="left">
                                                    <table style="background-position: center center;" width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-social es-p10t es-p5b es-m-txt-c" align="left">
                    ...
                    <tr>
                        <td class="esd-stripe" style="background-color: rgb(250, 250, 250);" bgcolor="#fafafa" align="center">
                            <table class="es-footer-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                <tbody>
                                <tr>
                                    <td class="esd-structure es-p10t es-p30b es-p20r es-p20l" style="border-radius: 0px 0px 10px 10px; background-color: rgb(11, 83, 148); background-position: left top;" bgcolor="#0b5394" align="left">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tbody>
                                            <tr>
                                                <td class="esd-container-frame" width="560" valign="top" align="center">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-menu">
                                                                <table class="es-menu" width="100%" cellspacing="0" cellpadding="0">
                                                                    <tbody>
                                                                    <tr class="links">
                                                                        <td class="es-p10t es-p10b es-p5r es-p5l" style="padding-bottom: 1px; padding-top: 0px; " width="33.33%" valign="top" bgcolor="transparent" align="center"> <a target="_blank" href style="color: #3D5CA3; font-size: 14px;">Sing up</a> </td>
                                                                        <td class="es-p10t es-p10b es-p5r es-p5l" style="border-left: 1px solid #3d5ca3; padding-bottom: 1px; padding-top: 0px; " width="33.33%" valign="top" bgcolor="transparent" align="center"> <a target="_blank" href style="color: #3D5CA3; font-size: 14px;">Blog</a> </td>
                                                                        <td class="es-p10t es-p10b es-p5r es-p5l" style="border-left: 1px solid #3d5ca3; padding-bottom: 1px; padding-top: 0px; " width="33.33%" valign="top" bgcolor="transparent" align="center"> <a target="_blank" href style="color: #3D5CA3; font-size: 14px;">About us</a> </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" esd-links-underline="underline" align="center">
                                                                <p style="font-size: 12px; color: #666666;">This daily newsletter was sent to info@name.com from company name because you subscribed. If you would not like to receive this email <a target="_blank" style="font-size: 12px; text-decoration: underline;">unsubscribe here</a>.</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
